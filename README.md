...
> **Agente IA Aguiavitech** — Versão brasileira do [Hermes Desktop v0.4.1](https://github.com/fathah/hermes-desktop/releases/tag/v0.4.1) com idioma nativo pt-BR, branding personalizado e deploy Docker para VPS.
