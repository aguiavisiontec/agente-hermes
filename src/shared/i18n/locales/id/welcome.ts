export default {
  title: "Selamat datang di Aguiavision",
  subtitle:
  ...
  dividerOr: "atau",
  connectRemote: "Hubungkan ke Agente Hermes Remote",
  connectRemoteTitle: "Hubungkan ke Agente Hermes Remote",
  connectRemoteSubtitle: "Masukkan URL server Agente Hermes API yang sedang berjalan.",
