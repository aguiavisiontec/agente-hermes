export default {
  title: "Bienvenido a Aguiavitech",
  subtitle:
  ...
  dividerOr: "o",
  connectRemote: "Conectarse a Agente IA Aguiavitech remoto",
  connectRemoteTitle: "Conectarse a Agente IA Aguiavitech remoto",
  connectRemoteSubtitle: "Introduce la URL de un servidor de API de Agente IA Aguiavitech en ejecución.",
