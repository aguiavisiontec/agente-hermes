export default {
  ...
  dividerOr: "ou",
  connectRemote: "Conectar ao Agente Hermes Remoto",
  connectRemoteTitle: "Conectar ao Agente Hermes Remoto",
  connectRemoteSubtitle: "Insira a URL de um servidor da API do Agente Hermes em execução.",
