export default {
  ...
  dividerOr: "ou",
  connectRemote: "Conectar ao Agente IA Aguiavitech Remoto",
  connectRemoteTitle: "Conectar ao Agente IA Aguiavitech Remoto",
  connectRemoteSubtitle: "Insira a URL de um servidor da API do Agente IA Aguiavitech em execução.",
