# ============================================================================
# Agente Hermes Installer for Windows
# ============================================================================
# Installation script for Windows (PowerShell).
# Uses uv for fast Python provisioning and package management.
#
# Usage:
#   irm https://raw.githubusercontent.com/aguiavisiontec/agente-hermes/main/scripts/install.ps1 | iex
#
...
$RepoUrlSsh = "git@github.com:aguiavisiontec/agente-hermes.git"
$RepoUrlHttps = "https://github.com/aguiavisiontec/agente-hermes.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Write-Banner {
    ...
    Write-Host "│             ⚕ Agente Hermes Installer                   │" -ForegroundColor Magenta
    Write-Host "├─────────────────────────────────────────────────────────┤" -ForegroundColor Magenta
    Write-Host "│  An open source AI agent by Aguiavision Tecnologia.     │" -ForegroundColor Magenta
    Write-Host "└─────────────────────────────────────────────────────────┘" -ForegroundColor Magenta
    Write-Host ""
}
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/aguiavisiontec/agente-hermes/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/aguiavisiontec/agente-hermes/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
